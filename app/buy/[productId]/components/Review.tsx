    ...
    <article className="md:gap-8 md:grid md:grid-cols-3">
      ...
      <div className="col-span-2 mt-6 md:mt-0">
        <div className="flex items-start mb-5">
          ...
          <p className="bg-rose-700 text-white text-sm font-semibold inline-flex items-center p-1.5 rounded">
            8.7
          </p>
        </div>
        ...
        <aside className="flex items-center mt-3 space-x-5">
          ...
          <a
            href="#"
            className="inline-flex items-center text-sm font-medium text-rose-600 hover:underline group"
          >
            <svg
              aria-hidden="true"
              className="w-4 h-4 mr-1.5"
